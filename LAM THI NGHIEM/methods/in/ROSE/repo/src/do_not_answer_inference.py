...
def parse_arguments():
    ...
    parser.add_argument('--model_path', type=str, default="vicuna-7b-delta-v1.1-convert/llama2_lmdeploy_4gpus/")
    parser.add_argument('--input_path', type=str, default="datasets/do-not-answer/do_not_answer_en.csv")
    parser.add_argument('--output_path', type=str, default="./output/do-not-answer")
...
def main(args):
    ...
    for id, instruction in tqdm(enumerate(infra_data["question"][data_min:data_max])):
